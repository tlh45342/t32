...
CASES = [{'name': 'forward', 'steps': 6, 'checks': ['r1 =0x0000002a', 'r15=0x00003000'], 'encoding_checks': [(20, '00000003')]}, {'name': 'next_instruction', 'steps': 6, 'checks': ['r1 =0x0000002a', 'r15=0x00003000'], 'encoding_checks': [(20, '00000003')]}, {'name': 'over_multiword', 'steps': 6, 'checks': ['r1 =0x00000000', 'r2 =0x00000000', 'r3 =0x0000002a', 'r15=0x00003000'], 'encoding_checks': [(20, '00000003')]}, {'name': 'stack_data_below_pc', 'steps': 8, 'checks': ['r4 =0x12345678', 'r5 =0x12345678', 'r15=0x00003000'], 'encoding_checks': [(32, '00000003')]}, {'name': 'preserve_registers', 'steps': 6, 'checks': ['r7 =0xabcdef01', 'r15=0x00003000'], 'encoding_checks': [(28, '00000003')]}]
