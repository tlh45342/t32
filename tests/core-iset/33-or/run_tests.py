...
CASES = [{'name': 'normal', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102021', 'checks': ['r2 =0x0000002a', 'zero=0', 'negative=0', 'carry=0', 'overflow=0']}, {'name': 'zero', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102021', 'checks': ['r2 =0x00000000', 'zero=1', 'negative=0']}, {'name': 'identity', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102021', 'checks': ['r2 =0xa5a5a5a5', 'negative=1', 'zero=0']}, {'name': 'all_ones', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102021', 'checks': ['r2 =0xffffffff', 'negative=1', 'zero=0']}, {'name': 'negative', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102021', 'checks': ['r2 =0x80000001', 'negative=1', 'zero=0']}, {'name': 'alias', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00100021', 'checks': ['r0 =0x0000002a', 'r1 =0x0000000a']}]
