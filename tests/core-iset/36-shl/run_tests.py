...
CASES = [{'name': 'normal', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102024', 'checks': ['r2 =0x0000002a', 'carry=0', 'zero=0', 'negative=0', 'overflow=0']}, {'name': 'zero_count', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102024', 'checks': ['r2 =0xa5a5a5a5', 'negative=1', 'zero=0']}, {'name': 'by_31', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102024', 'checks': ['r2 =0x80000000', 'negative=1', 'zero=0', 'carry=0']}, {'name': 'carry_out', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102024', 'checks': ['r2 =0x00000002', 'carry=1', 'negative=0', 'zero=0']}, {'name': 'zero_result', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102024', 'checks': ['r2 =0x00000000', 'carry=1', 'zero=1', 'negative=0']}, {'name': 'negative_result', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102024', 'checks': ['r2 =0x80000000', 'negative=1']}, {'name': 'alias', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00100024', 'checks': ['r0 =0x0000002a', 'r1 =0x00000001']}]
