...
CASES = [{'name': 'normal', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102018', 'checks': ['r0 =0x00000014', 'r1 =0x00000016', 'r2 =0x0000002a', 'carry=0', 'zero=0', 'negative=0', 'overflow=0']}, {'name': 'zero', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102018', 'checks': ['r2 =0x00000000', 'carry=0', 'zero=1', 'negative=0', 'overflow=0']}, {'name': 'carry', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102018', 'checks': ['r0 =0xffffffff', 'r1 =0x00000001', 'r2 =0x00000000', 'carry=1', 'zero=1', 'negative=0', 'overflow=0']}, {'name': 'overflow', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102018', 'checks': ['r2 =0x80000000', 'carry=0', 'zero=0', 'negative=1', 'overflow=1']}, {'name': 'negative', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102018', 'checks': ['r2 =0x80000001', 'carry=0', 'zero=0', 'negative=1', 'overflow=0']}, {'name': 'alias', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00100018', 'checks': ['r0 =0x0000002a', 'r1 =0x00000016', 'carry=0', 'zero=0', 'negative=0', 'overflow=0']}]
