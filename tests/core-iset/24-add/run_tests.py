...
CHECKS = [('binary loaded', 'loaded add.bin at 0x00001000'), ('result', 'r2 =0x0000002a'), ('pc', 'pc =0x00001018'), ('halted', 'state=halted'), ('instructions', 'instructions=4'), ('carry', 'carry=0'), ('zero', 'zero=0'), ('negative', 'negative=0'), ('overflow', 'overflow=0')]
