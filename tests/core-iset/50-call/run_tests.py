...
CASES = [{'name': 'forward', 'steps': 5, 'checks': ['r0 =0x0000002a', 'r15=0x00003000'], 'encoding_checks': [(8, '0000003214100000')]}, {'name': 'nested', 'steps': 9, 'checks': ['r0 =0x0000002a', 'r15=0x00003000'], 'encoding_checks': [(8, '0000003214100000'), (28, '0000003230100000')]}, {'name': 'sequential', 'steps': 9, 'checks': ['r0 =0x00000002', 'r15=0x00003000'], 'encoding_checks': [(16, '0000003224100000'), (24, '0000003224100000')]}, {'name': 'return_after_multiword', 'steps': 5, 'checks': ['r0 =0x0000002a', 'r15=0x00003000'], 'encoding_checks': [(8, '000000321c100000')]}, {'name': 'existing_stack_data', 'steps': 8, 'checks': ['r0 =0x0000002a', 'r4 =0x12345678', 'r5 =0x12345678', 'r15=0x00003000'], 'encoding_checks': [(20, '0000003224100000')]}, {'name': 'preserve_flags', 'steps': 7, 'checks': ['r2 =0x00000000', 'carry=1', 'zero=1', 'negative=0', 'overflow=0', 'r15=0x00003000'], 'encoding_checks': [(28, '0000003228100000')]}]
