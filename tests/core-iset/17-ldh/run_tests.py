...
CASES = [{'name': 'zero_extend_ffff', 'steps': 5, 'checks': ['r2 =0x0000ffff'], 'encoding_checks': [(20, '00002011')]}, {'name': 'little_endian_low', 'steps': 5, 'checks': ['r2 =0x0000ccdd'], 'encoding_checks': [(20, '00002011')]}, {'name': 'little_endian_high', 'steps': 6, 'checks': ['r2 =0x0000aabb'], 'encoding_checks': [(28, '00002011')]}, {'name': 'unaligned', 'steps': 5, 'checks': ['r2 =0x00001234'], 'encoding_checks': [(20, '00002011')]}, {'name': 'overwrite', 'steps': 7, 'checks': ['r2 =0x00005555'], 'encoding_checks': [(32, '00002011')]}, {'name': 'flags_preserved', 'steps': 7, 'checks': ['r2 =0x0000beef', 'carry=1', 'zero=1', 'negative=0', 'overflow=0'], 'encoding_checks': [(36, '00002011')]}]
