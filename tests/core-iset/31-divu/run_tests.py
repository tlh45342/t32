...
CASES = [{'name': 'normal', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201f', 'checks': ['r2 =0x0000002a', 'zero=0', 'negative=0', 'carry=0', 'overflow=0']}, {'name': 'smaller_by_larger', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201f', 'checks': ['r2 =0x00000000', 'zero=1', 'negative=0']}, {'name': 'max_by_two', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201f', 'checks': ['r2 =0x7fffffff', 'negative=0', 'zero=0']}, {'name': 'high_bit_by_two', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201f', 'checks': ['r2 =0x40000000', 'negative=0', 'zero=0']}, {'name': 'zero_dividend', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201f', 'checks': ['r2 =0x00000000', 'zero=1']}, {'name': 'identity', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201f', 'checks': ['r2 =0xffffffff', 'negative=1', 'zero=0']}, {'name': 'alias', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010001f', 'checks': ['r0 =0x0000002a', 'r1 =0x00000002']}]
