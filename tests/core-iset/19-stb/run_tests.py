...
CASES = [{'name': 'low_byte_only', 'steps': 5, 'checks': ['r2 =0x00000078'], 'encoding_checks': [(16, '00100013')]}, {'name': 'neighbor_preserved', 'steps': 7, 'checks': ['r2 =0xaabbcc11'], 'encoding_checks': [(28, '00100013')]}, {'name': 'overwrite', 'steps': 7, 'checks': ['r2 =0x00000055'], 'encoding_checks': [(16, '00100013')]}, {'name': 'build_word', 'steps': 15, 'checks': ['r2 =0x44332211'], 'encoding_checks': [(16, '00100013')]}, {'name': 'source_preserved', 'steps': 4, 'checks': ['r0 =0x00003000', 'r1 =0xabcdef7e'], 'encoding_checks': [(16, '00100013')]}, {'name': 'flags_preserved', 'steps': 6, 'checks': ['carry=1', 'zero=1', 'negative=0', 'overflow=0'], 'encoding_checks': [(32, '00100013')]}]
