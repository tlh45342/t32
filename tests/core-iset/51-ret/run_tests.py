...
CHECKS = [('binary loaded', 'loaded ret.bin at 0x00001000'), ('returned', 'r0 =0x0000002a'), ('stack restored', 'r15=0x00003000'), ('halted', 'state=halted'), ('instructions', 'instructions=5')]
