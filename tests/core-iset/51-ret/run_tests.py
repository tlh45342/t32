...
CASES = [{'name': 'basic', 'steps': 5, 'checks': ['r0 =0x0000002a', 'r15=0x00003000'], 'encoding_checks': [(28, '00000033')]}, {'name': 'nested', 'steps': 9, 'checks': ['r0 =0x0000002a', 'r15=0x00003000'], 'encoding_checks': [(44, '00000033'), (56, '00000033')]}, {'name': 'sequential', 'steps': 9, 'checks': ['r0 =0x00000002', 'r15=0x00003000'], 'encoding_checks': [(44, '00000033')]}, {'name': 'stack_data_survives', 'steps': 7, 'checks': ['r5 =0x12345678', 'r15=0x00003000'], 'encoding_checks': [(36, '00000033')]}, {'name': 'return_to_movi', 'steps': 5, 'checks': ['r6 =0xabcdef01', 'r15=0x00003000'], 'encoding_checks': [(28, '00000033')]}]
