...
CASES = [{'name': 'forward', 'steps': 3, 'checks': ['r0 =0x0000002a'], 'encoding_checks': [(0, '0000002a10100000')]}, {'name': 'next_instruction', 'steps': 3, 'checks': ['r0 =0x0000002a'], 'encoding_checks': [(0, '0000002a08100000')]}, {'name': 'over_multiword', 'steps': 4, 'checks': ['r0 =0x00000001', 'r1 =0x00000000', 'r2 =0x00000000', 'r3 =0x0000002a'], 'encoding_checks': [(8, '0000002a20100000')]}, {'name': 'backward', 'steps': 14, 'checks': ['r0 =0x00000003', 'r1 =0x00000000'], 'encoding_checks': [(40, '0000002a10100000')]}, {'name': 'preserve_flags', 'steps': 5, 'checks': ['r2 =0x00000000', 'carry=1', 'zero=1', 'negative=0', 'overflow=0'], 'encoding_checks': [(20, '0000002a24100000')]}]
