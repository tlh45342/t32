...
CASES = [{'name': 'taken_positive', 'steps': 4, 'checks': ['r0 =0x00000001', 'r1 =0x0000002a'], 'encoding_checks': [(8, '0000002c18100000')]}, {'name': 'not_taken_zero', 'steps': 4, 'checks': ['r0 =0x00000000', 'r1 =0x0000002a'], 'encoding_checks': [(8, '0000002c1c100000')]}, {'name': 'taken_negative', 'steps': 4, 'checks': ['r0 =0x80000000', 'r1 =0x0000002a'], 'encoding_checks': [(8, '0000002c18100000')]}, {'name': 'over_multiword', 'steps': 4, 'checks': ['r1 =0x00000000', 'r2 =0x00000000', 'r3 =0x0000002a'], 'encoding_checks': [(8, '0000002c20100000')]}, {'name': 'source_preserved', 'steps': 4, 'checks': ['r7 =0x00000007', 'r0 =0x0000002a'], 'encoding_checks': [(8, '0000072c18100000')]}, {'name': 'backward_loop', 'steps': 12, 'checks': ['r0 =0x00000000', 'r1 =0x00000003'], 'encoding_checks': [(32, '0000002c10100000')]}]
