...
CASES = [{'name': 'normal', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201e', 'checks': ['r2 =0x0000002a', 'zero=0', 'negative=0', 'carry=0', 'overflow=0']}, {'name': 'positive_negative', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201e', 'checks': ['r2 =0xffffffd6', 'negative=1', 'zero=0']}, {'name': 'negative_positive', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201e', 'checks': ['r2 =0xffffffeb', 'negative=1', 'zero=0']}, {'name': 'negative_negative', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201e', 'checks': ['r2 =0x0000002a', 'negative=0', 'zero=0']}, {'name': 'zero_dividend', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201e', 'checks': ['r2 =0x00000000', 'zero=1', 'negative=0']}, {'name': 'truncate_positive', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201e', 'checks': ['r2 =0x00000003', 'negative=0', 'zero=0']}, {'name': 'truncate_negative', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201e', 'checks': ['r2 =0xfffffffd', 'negative=1', 'zero=0']}, {'name': 'alias', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010001e', 'checks': ['r0 =0x0000002a', 'r1 =0x00000002']}]
