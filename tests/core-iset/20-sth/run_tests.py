...
CASES = [{'name': 'low_half_only', 'steps': 5, 'checks': ['r2 =0x00005678'], 'encoding_checks': [(16, '00100014')]}, {'name': 'little_endian_bytes', 'steps': 7, 'checks': ['r2 =0x00000034', 'r3 =0x00000012'], 'encoding_checks': [(16, '00100014')]}, {'name': 'upper_half_preserved', 'steps': 7, 'checks': ['r2 =0xaabb1122'], 'encoding_checks': [(28, '00100014')]}, {'name': 'unaligned', 'steps': 5, 'checks': ['r2 =0x0000beef'], 'encoding_checks': [(16, '00100014')]}, {'name': 'overwrite', 'steps': 7, 'checks': ['r2 =0x00005555'], 'encoding_checks': [(16, '00100014')]}, {'name': 'flags_preserved', 'steps': 6, 'checks': ['carry=1', 'zero=1', 'negative=0', 'overflow=0'], 'encoding_checks': [(32, '00100014')]}]
