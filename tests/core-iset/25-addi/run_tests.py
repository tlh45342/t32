...
CASES = [{'name': 'normal', 'steps': 3, 'encoding_offset': 8, 'encoding_hex': '0000101916000000', 'checks': ['r0 =0x00000014', 'r1 =0x0000002a', 'carry=0', 'zero=0', 'negative=0', 'overflow=0']}, {'name': 'zero_imm', 'steps': 3, 'encoding_offset': 8, 'encoding_hex': '0000101900000000', 'checks': ['r0 =0x0000002a', 'r1 =0x0000002a', 'carry=0', 'zero=0', 'negative=0', 'overflow=0']}, {'name': 'carry', 'steps': 3, 'encoding_offset': 8, 'encoding_hex': '0000101901000000', 'checks': ['r1 =0x00000000', 'carry=1', 'zero=1', 'negative=0', 'overflow=0']}, {'name': 'overflow', 'steps': 3, 'encoding_offset': 8, 'encoding_hex': '0000101901000000', 'checks': ['r1 =0x80000000', 'carry=0', 'zero=0', 'negative=1', 'overflow=1']}, {'name': 'negative', 'steps': 3, 'encoding_offset': 8, 'encoding_hex': '0000101901000000', 'checks': ['r1 =0x80000001', 'carry=0', 'zero=0', 'negative=1', 'overflow=0']}, {'name': 'alias', 'steps': 3, 'encoding_offset': 8, 'encoding_hex': '0000001916000000', 'checks': ['r0 =0x0000002a', 'carry=0', 'zero=0', 'negative=0', 'overflow=0']}]
