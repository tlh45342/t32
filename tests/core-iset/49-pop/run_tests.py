...
CASES = [{'name': 'single', 'steps': 5, 'checks': ['r1 =0x0000002a', 'r15=0x00003000'], 'encoding_checks': [(20, '00001031')]}, {'name': 'overwrite', 'steps': 6, 'checks': ['r1 =0x0000002a', 'r15=0x00003000'], 'encoding_checks': [(28, '00001031')]}, {'name': 'lifo', 'steps': 8, 'checks': ['r2 =0x22222222', 'r3 =0x11111111', 'r15=0x00003000'], 'encoding_checks': [(32, '00002031'), (36, '00003031')]}, {'name': 'zero', 'steps': 5, 'checks': ['r9 =0x00000000', 'r15=0x00003000'], 'encoding_checks': [(20, '00009031')]}, {'name': 'negative', 'steps': 5, 'checks': ['r9 =0xffffffff', 'r15=0x00003000'], 'encoding_checks': [(20, '00009031')]}, {'name': 'source_preserved', 'steps': 5, 'checks': ['r0 =0x0000002a', 'r1 =0x0000002a'], 'encoding_checks': [(20, '00001031')]}]
