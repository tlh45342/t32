...
CASES = [{'name': 'normal', 'steps': 3, 'encoding_offset': 8, 'encoding_hex': '00001023', 'checks': ['r0 =0xffffffd5', 'r1 =0x0000002a', 'zero=0', 'negative=0', 'carry=0', 'overflow=0']}, {'name': 'zero', 'steps': 3, 'encoding_offset': 8, 'encoding_hex': '00001023', 'checks': ['r1 =0xffffffff', 'negative=1', 'zero=0']}, {'name': 'ones', 'steps': 3, 'encoding_offset': 8, 'encoding_hex': '00001023', 'checks': ['r1 =0x00000000', 'zero=1', 'negative=0']}, {'name': 'alternating', 'steps': 3, 'encoding_offset': 8, 'encoding_hex': '00001023', 'checks': ['r1 =0x55555555', 'negative=0', 'zero=0']}, {'name': 'high_bit', 'steps': 3, 'encoding_offset': 8, 'encoding_hex': '00001023', 'checks': ['r1 =0x80000000', 'negative=1', 'zero=0']}, {'name': 'alias', 'steps': 3, 'encoding_offset': 8, 'encoding_hex': '00000023', 'checks': ['r0 =0x0000002a']}]
