...
CASES = [{'name': 'normal', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102020', 'checks': ['r0 =0x0000002f', 'r1 =0x0000002a', 'r2 =0x0000002a', 'zero=0', 'negative=0', 'carry=0', 'overflow=0']}, {'name': 'zero', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102020', 'checks': ['r2 =0x00000000', 'zero=1', 'negative=0']}, {'name': 'identity', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102020', 'checks': ['r2 =0xa5a5a5a5', 'zero=0', 'negative=1']}, {'name': 'mask', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102020', 'checks': ['r2 =0x00f000f0', 'zero=0', 'negative=0']}, {'name': 'negative', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00102020', 'checks': ['r2 =0x80000001', 'negative=1', 'zero=0']}, {'name': 'alias', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '00100020', 'checks': ['r0 =0x0000002a', 'r1 =0x0000002a']}]
