...
CASES = [{'name': 'normal', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201d', 'checks': ['r2 =0x0000002a', 'zero=0', 'negative=0', 'carry=0', 'overflow=0']}, {'name': 'zero', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201d', 'checks': ['r2 =0x00000000', 'zero=1', 'negative=0']}, {'name': 'identity', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201d', 'checks': ['r2 =0xffffffff', 'negative=1', 'zero=0']}, {'name': 'max_times_two', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201d', 'checks': ['r2 =0xfffffffe', 'negative=1', 'zero=0']}, {'name': 'high_bit_wrap', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201d', 'checks': ['r2 =0x00000000', 'zero=1', 'negative=0']}, {'name': 'alternating', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201d', 'checks': ['r2 =0x00020001', 'zero=0', 'negative=0']}, {'name': 'alias', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010001d', 'checks': ['r0 =0x0000002a', 'r1 =0x00000007']}]
