...
CASES = [{'name': 'taken_zero', 'steps': 4, 'checks': ['r0 =0x00000000', 'r1 =0x0000002a'], 'encoding_checks': [(8, '0000002b18100000')]}, {'name': 'not_taken_positive', 'steps': 4, 'checks': ['r0 =0x00000001', 'r1 =0x0000002a'], 'encoding_checks': [(8, '0000002b1c100000')]}, {'name': 'not_taken_negative', 'steps': 4, 'checks': ['r0 =0xffffffff', 'r1 =0x0000002a'], 'encoding_checks': [(8, '0000002b1c100000')]}, {'name': 'over_multiword', 'steps': 4, 'checks': ['r1 =0x00000000', 'r2 =0x00000000', 'r3 =0x0000002a'], 'encoding_checks': [(8, '0000002b20100000')]}, {'name': 'source_preserved', 'steps': 4, 'checks': ['r7 =0x00000000', 'r0 =0x0000002a'], 'encoding_checks': [(8, '0000072b18100000')]}, {'name': 'backward_exit', 'steps': 8, 'checks': ['r0 =0x00000000', 'r1 =0x0000002a'], 'encoding_checks': [(16, '0000002b20100000')]}]
