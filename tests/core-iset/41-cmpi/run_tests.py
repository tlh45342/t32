...
CASES = [{'name': 'equal', 'steps': 3, 'encoding_offset': 8, 'encoding_hex': '000000292a000000', 'checks': ['r0 =0x0000002a', 'carry=1', 'zero=1', 'negative=0', 'overflow=0']}, {'name': 'greater', 'steps': 3, 'encoding_offset': 8, 'encoding_hex': '0000002914000000', 'checks': ['r0 =0x0000002a', 'carry=1', 'zero=0', 'negative=0', 'overflow=0']}, {'name': 'less', 'steps': 3, 'encoding_offset': 8, 'encoding_hex': '0000002905000000', 'checks': ['r0 =0x00000003', 'carry=0', 'zero=0', 'negative=1', 'overflow=0']}, {'name': 'signed_overflow', 'steps': 3, 'encoding_offset': 8, 'encoding_hex': '0000002901000000', 'checks': ['r0 =0x80000000', 'carry=1', 'zero=0', 'negative=0', 'overflow=1']}, {'name': 'zero', 'steps': 3, 'encoding_offset': 8, 'encoding_hex': '0000002900000000', 'checks': ['r0 =0x00000000', 'carry=1', 'zero=1', 'negative=0', 'overflow=0']}]
