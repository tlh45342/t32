...
CASES = [{'name': 'roundtrip', 'steps': 5, 'checks': ['r2 =0x12345678'], 'encoding_checks': [(16, '00100015')]}, {'name': 'little_endian_bytes', 'steps': 11, 'checks': ['r2 =0x00000011', 'r3 =0x00000022', 'r4 =0x00000033', 'r5 =0x00000044'], 'encoding_checks': [(16, '00100015')]}, {'name': 'overwrite', 'steps': 7, 'checks': ['r2 =0x55555555'], 'encoding_checks': [(16, '00100015')]}, {'name': 'unaligned', 'steps': 5, 'checks': ['r2 =0x89abcdef'], 'encoding_checks': [(16, '00100015')]}, {'name': 'zero', 'steps': 5, 'checks': ['r2 =0x00000000'], 'encoding_checks': [(16, '00100015')]}, {'name': 'flags_preserved', 'steps': 6, 'checks': ['carry=1', 'zero=1', 'negative=0', 'overflow=0'], 'encoding_checks': [(32, '00100015')]}]
