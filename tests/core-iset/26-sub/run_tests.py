...
CASES = [{'name': 'normal', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201a', 'checks': ['r0 =0x0000002a', 'r1 =0x00000014', 'r2 =0x00000016', 'carry=1', 'zero=0', 'negative=0', 'overflow=0']}, {'name': 'equal', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201a', 'checks': ['r2 =0x00000000', 'carry=1', 'zero=1', 'negative=0', 'overflow=0']}, {'name': 'borrow', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201a', 'checks': ['r2 =0xfffffffe', 'carry=0', 'zero=0', 'negative=1', 'overflow=0']}, {'name': 'underflow', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201a', 'checks': ['r2 =0xffffffff', 'carry=0', 'zero=0', 'negative=1', 'overflow=0']}, {'name': 'overflow', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010201a', 'checks': ['r2 =0x7fffffff', 'carry=1', 'zero=0', 'negative=0', 'overflow=1']}, {'name': 'alias', 'steps': 4, 'encoding_offset': 16, 'encoding_hex': '0010001a', 'checks': ['r0 =0x00000016', 'r1 =0x00000014', 'carry=1', 'zero=0', 'negative=0', 'overflow=0']}]
