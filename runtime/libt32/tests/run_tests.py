...
def main():
 ...
 listing=run(['t32-ar','t',str(ARCHIVE)]); members=listing.stdout.splitlines()
 if listing.returncode or len(members)!=16 or 'strlen.o' not in members: fail('archive contains sixteen members',listing.stdout)
