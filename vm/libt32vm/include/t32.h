...
/* RTC MMIO: read-only UTC wall-clock time. */
#define T32_RTC_BASE UINT32_C(0x90003000)
#define T32_RTC_MMIO_SIZE UINT32_C(0x0000000C)
#define T32_RTC_ID UINT32_C(0x54335231) /* "T3R1" */
#define T32_RTC_REG_ID UINT32_C(0x00)
#define T32_RTC_REG_STATUS UINT32_C(0x04)
#define T32_RTC_REG_EPOCH UINT32_C(0x08)
#define T32_RTC_STATUS_VALID UINT32_C(0x00000001)
